    ...
    Column(
        ...
        Box(
            ...
            Column(
                ...
                ClickableTextWithIcon(navController = navController, text = "Notification Settings",icon = R.drawable.notification, route = "notification_settings" )
                ClickableTextWithIcon(navController = navController, text = "Change language", icon = R.drawable.language, route = "")
                ClickableTextWithIcon(navController = navController, text = "Delete account", icon = R.drawable.delete_account, route = "delete_account")
            }
        }
...
@Composable
fun ClickableTextWithIcon(navController: NavController, text: String, icon: Int? = null, route: String? = null) {
    OutlinedButton(
        onClick = {
